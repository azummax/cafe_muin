...
*/
$menu['menu410'] = array (
    array('410000', '주문관리', G5_ADMIN_URL.'/shop_admin/orderlist.php', 'scf_order'),
    array('410400', '주문내역', G5_ADMIN_URL.'/shop_admin/orderlist.php', 'scf_order','1'),
	array('410410', '미완료주문', G5_ADMIN_URL.'/shop_admin/inorderlist.php', 'scf_inorder'),
	array('410800', '쿠폰관리', G5_ADMIN_URL.'/shop_admin/couponlist.php', 'scf_coupon'),
    array('410810', '쿠폰존관리', G5_ADMIN_URL.'/shop_admin/couponzonelist.php', 'scf_coupon_zone'),
    array('410750', '추가배송비관리', G5_ADMIN_URL.'/shop_admin/sendcostlist.php', 'scf_sendcost', 1),
