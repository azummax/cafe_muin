...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" ><?php echo subject_sort_link('pt_main', 'sca='.$sca); ?>메인</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<!-- APMS - 2014.07.20 -->
		<td  class="td_num" style="white-space:nowrap">
		...
		<!-- // -->
		<td   class="td_sort" style="width:220px;text-align:center">
            <label for="ca_id_<?php echo $i; ?>" class="sound_only"><?php echo get_text($row['it_name']); ?> 기본분류</label>
            <select name="ca_id[<?php echo $i; ?>]" id="ca_id_<?php echo $i; ?>" required style="width:40%">
            ...
            <select name="ca_id2[<?php echo $i; ?>]" id="ca_id2_<?php echo $i; ?>" style="width:40%">
        ...
        <td headers="th_pc_title"  class="td_input td_left">
...
<div class="btn_fixed_top">
    <a href="./itemform.php?fn=1" class="btn btn_01">상품등록</a>
