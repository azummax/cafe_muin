...
if(G5_IS_MOBILE) {
    $page_rows = $board['bo_mobile_page_rows'] ? $board['bo_mobile_page_rows'] : $board['bo_page_rows'];
    $list_page_rows = $board['bo_mobile_page_rows'] ? $board['bo_mobile_page_rows'] : $board['bo_page_rows'];
    // 0 일 경우 디폴트값 보강 (오류 방지)
    if (!$page_rows) $page_rows = 15;
    if (!$list_page_rows) $list_page_rows = 15;
} else {
