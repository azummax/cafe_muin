...
//------------------------------------------------------------------------------
if (G5_IS_MOBILE) {
    $tmp_bo_mobile_skin = $board['bo_mobile_skin'] ? $board['bo_mobile_skin'] : $board['bo_skin'];
    $board_skin_path    = get_skin_path('board', $tmp_bo_mobile_skin);
    $board_skin_url     = get_skin_url('board', $tmp_bo_mobile_skin);
