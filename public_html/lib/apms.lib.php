...
function apms_get_star($avg, $opt='') {
	...
	for($j=0; $j < $star_s; $j++) {
		$star .= '<img src="/thema/Basic/img/item_star.png" alt="" />';
	}
	if($star_m) $star .= '<img src="/thema/Basic/img/item_star_half.png" alt="" />';
	for($j=0; $j < $star_e; $j++) {
		$star .= '<img src="/thema/Basic/img/item_star_no.png" alt="" />';
	}
...
// BS3 Style
function apms_paging($write_pages, $cur_page, $total_page, $url, $add='', $first='<img src="/thema/Basic/img/paging_prev01.png" alt="첫번째 페이지">', $prev='<img src="/thema/Basic/img/paging_prev02.png" alt="이전 페이지">', $next='<img src="/thema/Basic/img/paging_next02.png" alt="다음 페이지">', $last='<img src="/thema/Basic/img/paging_next01.png" alt="마지막 페이지">') {
	...
	if ($cur_page > 1) {
		$str .= '<li class="mgR"><a href="'.$url.($cur_page-1).$add.'">'.$prev.'</a></li>';
	} else {
		$str .= '<li class="disabled mgR"><a>'.$prev.'</a></li>';
	}
	...
	if ($cur_page < $total_page) {
		$str .= '<li class="mgL"><a href="'.$url.($cur_page+1).$add.'">'.$next.'</a></li>';
	} else {
		$str .= '<li class="disabled mgL"><a>'.$next.'</a></li>';
	}
...
function apms_ajax_paging($id, $write_pages, $cur_page, $total_page, $url, $add='', $first='<img src="/thema/Basic/img/paging_prev01.png" alt="첫번째 페이지">', $prev='<img src="/thema/Basic/img/paging_prev02.png" alt="이전 페이지">', $next='<img src="/thema/Basic/img/paging_next02.png" alt="다음 페이지">', $last='<img src="/thema/Basic/img/paging_next01.png" alt="마지막 페이지">') {
	...
	if ($cur_page > 1) {
		$str .= '<li class="mgR"><a href="javascript:;" onclick="apms_page(\''.$id.'\', \''.$url.($cur_page-1).$add.'\', \'1\');">'.$prev.'</a></li>';
	} else {
		$str .= '<li class="disabled mgR"><a>'.$prev.'</a></li>';
	}
	...
	if ($cur_page < $total_page) {
		$str .= '<li class="mgL"><a href="javascript:;" onclick="apms_page(\''.$id.'\', \''.$url.($cur_page+1).$add.'\', \'1\');">'.$next.'</a></li>';
	} else {
		$str .= '<li class="disabled mgL"><a>'.$next.'</a></li>';
	}
...
function apms_jwplayer($file, $img='', $caption='', $title=''){
	...
	if(defined('APMS_USE_VIDEO_TAG') && APMS_USE_VIDEO_TAG) {
		if($ext == "mp4" || $ext == "webm") {
			$player = '<div class="div-iframe"><div class="iframe-wrap">';
			$player .= '<video src="'.$file.'" controls';
			if(APMS_USE_VIDEO_TAG == "2") {
				$player .= ' autoplay';
			}
			if($img) {
				$player .= ' poster="'.$img.'"';
			...
			$player = '<audio src="'.$file.'" controls';
			if(APMS_USE_VIDEO_TAG == "2") {
				$player .= ' autoplay';
			}
