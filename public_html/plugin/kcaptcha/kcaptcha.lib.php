...
function captcha_html($class="captcha")
{
    ...
    $html .= "\n".'<img src="'.G5_CAPTCHA_URL.'/img/dot.gif" alt="자동 가입 방지 CAPTCHA" id="captcha_img">';
    $html .= "\n".'<button type="button" id="captcha_mp3"><span></span>숫자음성듣기</button>';
    $html .= "\n".'<button type="button" id="captcha_reload"><span></span>새로고침</button>';
	$html .= '<input type="text" name="captcha_key" id="captcha_key" required class="captcha_box required" size="6" maxlength="6" placeholder="숫자를 순서대로 입력" title="자동등록방지 숫자를 순서대로 입력하세요.">';
    $html .= "\n".'</fieldset>';
    return $html;
}
