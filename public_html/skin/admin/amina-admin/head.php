...
<header id="hd">
	<div id="hd_wrap">
		...
		<div id="logo"><a href="<?php echo G5_ADMIN_URL ?>">관리자페이지<?php //echo apms_fa($aset['logo']);?></a></div>

		<ul id="tnb">
			<li><a href="http://www.withi.kr/withi_board/list.php?company=withi-1680654040">유지보수 문의</a></li>
			<li><a href="<?php echo G5_ADMIN_URL ?>/member_form.php?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>">관리자정보</a></li>
		<? if($member['mb_id'] == "nurii"){ ?>
		...
		<?}?>
			...
			<?php } ?>
			-->
			<li><a href="<?php echo G5_URL ?>/">홈페이지 이동</a></li>
