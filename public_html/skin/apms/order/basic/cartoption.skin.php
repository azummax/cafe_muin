...
?>
<div id="mod_option_form" class="option_modal">
	<form name="foption" class="form" role="form" method="post" action="<?php echo $action_url; ?>" onsubmit="return formcheck(this);">
		...
		<strong class="modal_tit01">선택옵션 수정</strong>

		<?php if($option_1) { ?>
			<!-- <strong class="modal_tit02">선택옵션</strong> -->
			<table class="opt-tbl">
			<tbody>
		...
		<?php if($option_2) { ?>
			<!-- <strong class="modal_tit02">추가옵션</strong> -->
			<table class="opt-tbl">
			<tbody>
		...
		<div class="btm_button">
			<button type="submit" class="on">적용하기</button>
