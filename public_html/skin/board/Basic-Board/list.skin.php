...
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>"> 
	...
	<div id="board_list_top">
		<?php
			// 총게시물수
			$write_total = sql_fetch(" select sum(bo_count_write) as sum_count_write from {$g5['board_table']} where bo_table = '{$bo_table}' ");
			$total_cnt = $write_total['sum_count_write'];
		?>
		<strong class="board_total">Total<b><?php echo $total_cnt; ?></b></strong>

		<form name="fhsearch" method="get" role="form" class="search_form">
			<input type="hidden" name="bo_table" value="<?php echo $bo_table ?>">
			<input type="hidden" name="sca" value="<?php echo $sca ?>">
			<div class="search_box">
				<label for="sfl" class="sound_only">검색조건</label>
				<select name="sfl" class="input_com" id="sfl">
	...
	<div class="list-wrap">
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			...
			?>
			<div class="list-btn">
				<div class="btn-group dropup" role="group" style="display:none;">
