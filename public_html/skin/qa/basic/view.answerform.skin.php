		...
		<div class="answer_write">
			...
			<input type="hidden" name="token" value="<?php echo get_text($token); ?>">
				<div class="form-group<?php if(!$is_dhtml_editor) echo ' input-group';?>">
					...
					<input type="text" name="qa_subject" value="" id="qa_subject" required class="input_com" placeholder="제목" size="50" maxlength="255">
					<?php
						if ($is_dhtml_editor) {
				...
				<div class="text-center">
					<button type="submit" id="btn_submit" accesskey="s" class="board_btn answer_btn">답변등록</button>
				</div>
			</form>
