...
<section class="cm_hero">
    <div class="cm_hero_text">
        <h2>Healthy from Nature.<br>Good for You, Gentle on the Earth.</h2>
    </div>
    <div class="cm_hero_images">
        <div class="hero_img hero_img_left">
            <img src="/thema/Basic/img/hero1.jpg" alt="시금치와 채소가 있는 자연 배경" onerror="this.src='https://placehold.co/600x800/1e1e1e/white?text=Image+1'">
        </div>
        <div class="hero_img hero_img_center">
            <img src="/thema/Basic/img/hero2.jpg" alt="상큼한 복숭아 아이스티 음료" onerror="this.src='https://placehold.co/600x800/ff6a12/white?text=Image+2'">
        </div>
        <div class="hero_img hero_img_right">
            <img src="/thema/Basic/img/hero3.jpg" alt="신선한 과일과 채소" onerror="this.src='https://placehold.co/600x800/0bab6d/white?text=Image+3'">
        </div>
    </div>
</section>
